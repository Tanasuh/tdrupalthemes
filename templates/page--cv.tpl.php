...
<div class="page_logo">
    <div class="container">
        <a href="<?php print $front_page; ?>">
	        <?php
            $address = '' . base_path() . path_to_theme() . '/cust/page_logo.png';
            global $base_root;
...
<?php if (!empty($title)): ?>
                <div class="page-header-bg">
                    <h1 class="page-header<?php if (isset($node->type)) {
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="modal-title">موقع الشيخ حمزة أبوفارس<a class="anchorjs-link" href="#modal-title"><span class="anchorjs-icon"></span></a></h4>
          </div>
